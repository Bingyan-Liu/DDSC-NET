...
class DDSC_Net(nn.Module):
    ...
    def __init__(self, in_channel=3,out_channel=3):
        ...
        self.block4_5 = Block(512, 512)
        # self.block4_6 = Block(512, 512)


        self.upcon4 = TransitionUp(512,256)

        # self.attention5 =Attention_block(256,256,128)
        ...
        # self.block5_6 = Block(256, 256)
        # self.block5_7 = Block(256, 256)
        ...
        # self.attention6 =Attention_block(128,128,64)


        self.block6 = Block(256, 128)
        self.block6_2 = Block(128, 128)
        self.block6_3 = Block(128, 128)
        self.block6_4 = Block(128, 128)
        # self.block6_5 = Block(128, 128)


        self.upcon6 = TransitionUp(128,64)

        # self.attention7 =Attention_block(64,64,32)


        self.block7 = Block(128, 64)
        self.block7_2 = Block(64, 64)
        self.block7_3 = Block(64, 64)
